...
<div class="card">
    <div class="card-body">
      ...
      <form id="formAuthentication" class="mb-3" action="{{ route('back.verification.send') }}" method="POST">
        @csrf
        <button class="btn btn-primary d-grid w-100">Resend</button>
      </form>
      <div class="text-center">

        <form id="formAuthentication" class="mb-3" action="{{ route('back.logout') }}" method="POST">
            @csrf
            <a href="#" class="d-flex align-items-center justify-content-center" onclick="this.closest('form').submit();return false;">
